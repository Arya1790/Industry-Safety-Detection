...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact: 
        ...
        try:
            ...
            if status:
                logging.info('-------')
                logging.info(os.path.abspath(self.data_ingestion_artifact.data_zip_file_path))
                logging.info(os.getcwd())
                shutil.copy(self.data_ingestion_artifact.data_zip_file_path, os.getcwd())
                # shutil.copy(os.path.abspath(self.data_ingestion_artifact.data_zip_file_path), os.getcwd())
